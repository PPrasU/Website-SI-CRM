<title>SI CRM | Edit Distributor</title>
            ...
            <div class="box-body"> 
                <form action="/updateDistributor/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="string" name="id_distributor" value="{{ $data->id_distributor }}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Nama Distributor</label>
                        <input type="string" name="nama_distributor" value="{{ $data->nama_distributor }}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="jenis_barang">
                                ...
                                <option disabled>--Pilih Tipe Barang--</option>
                                <option>Sabun</option>
