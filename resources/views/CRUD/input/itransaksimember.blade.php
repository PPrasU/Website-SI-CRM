<title>SI CRM | Input Transaksi Member</title>
...
<div class="content-wrapper">
    <!-- Content Header (Page header) -->
      <section class="content-header">
          ...
          <li class="active">Input Transaksi Member</li>
          </ol>
      </section>
      <!-- Main content -->
    <section class="content">
        ...
        <div class="box box-default color-palette-box">
            <div class="box-body"> 
                <form action="/instRTransaksiMember" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">ID Transaksi Member (TM00000001)</label>
                        <input type="string" name="id_transaksiM" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <div class="form-group">
                            <label>ID Member</label>
                            <select class="form-control" name="member_id">
                                <option selected disabled>--Pilih ID Member--</option>
                                @foreach ($member as $m)
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="jenistransaksi_id">
                                <option selected disabled>--Pilih ID Jenis Transaksi--</option>
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="karyawan_id">
                                <option selected disabled>--Pilih ID Karyawan--</option>
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="jasa_id" id="jasa">
                                <option selected disabled>--Pilih ID Jasa--</option>
                                @foreach ($jasa as $j)
                                    <option value="{{ $j->id }}" data-harga="{{ $j->harga }}">{{ $j->id_jasa }}-{{ $j->nama_jasa }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="penukaran_id">
                                <option selected disabled>--Pilih ID Penukaran--</option>
